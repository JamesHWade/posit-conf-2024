...
1.  Drive faster with coding assistants but don't forget to steer
2.  Prompting matters: learning to use these AI tools is a skill
3.  ...?
:::
...
## Acknowledgements {.center .smaller}

::: {.columns .r-fit-text}
::: {.column width="50%"}
-  [Tony Sokolov]{.yellow}
-  Michael Hausinger
-  Our (Apprentice) Mentors
